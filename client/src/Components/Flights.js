...
//   // Get selected departure airport from dropdown and change state
//   const handleDeparture = (e) => {
//     console.log("from =", e.target.value);
//     setDepartureAirport(e.target.value);
//   };

//   // Get selected arrival airport from dropdown and change state
//   const handleArrival = (e) => {
//     console.log("to =", e.target.value);
//     setArrivalAirport(e.target.value);
//   };
...
//   const handleDate = (e) => {
//     console.log("nowdate =", e.target.value);
//   };
...
//             <TravelCalendar onSelect={handleDate} />
//             <p>
//               You're going away from {flyDate[0]} to {flyDate[1]}, and
//               travelling from
//               {departureAirport} Airport to {arrivalAirport} airport
